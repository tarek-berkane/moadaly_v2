...
import 'package:moadaly_2_1/data/schema.dart';
import 'package:moadaly_2_1/screens/partial/year_button.dart';
      ...
      children: [
        ...
        Padding(
          ...
          child: Wrap(
            ...
            crossAxisAlignment: WrapCrossAlignment.center,
            children: [
              for (var speciality in yearGradeData) YearButton(speciality)
            ],
          ),
        ),
      ],
