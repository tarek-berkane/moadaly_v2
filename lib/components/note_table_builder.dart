...
import 'package:moadaly_2_1/components/text.dart';
import 'package:moadaly_2_1/controller/note_controller.dart';
import 'package:moadaly_2_1/screens/partial/note_input.dart';
...
class NoteTableBuilder {
            ...
            children: [
              TableCell(
                child: SizedBox(
                  ...
                  // color: Colors.red,
                  child: Center(
                      child: textTable("Semestre/année", color: Colors.white)),
                ),
              ),
  ...
  List buildUnity(NoteController controller, String semesterName, int unityId) {
    ...
    items.add(
      ...
      TableCell(
          child: Center(
              child: textUnity(controller.notes[semesterName]['unites'][unityId]
                      ['coef']
                  .toString()))),
      TableCell(
          child: Center(
      ...
      children: [
        TableCell(
          child: Container(
            ...
            child: Center(
              child: textTable(
                  controller.notes[semesterName]['unites'][unityId]['modules']
                      [moduleId]['title'],
                  fontSize: 10),
            ),
          ),
